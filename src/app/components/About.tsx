...
const About = () => {
  ...
  return (
    <div>
      <main className='relative flex items-center flex-col justify-center bg-[#161616] px-10 pt-10 pb-60 z-1 max-lg:h-auto max-lg:py-20 max-md:px-4'>
        ...
        <motion.section
          ...
          className='flex flex-col gap-40 py-20 max-xl:min-w-auto max-2xl:min-w-[1180px] max-md:py-4 max-md:gap-24'
        >
          <div className='flex flex-col items-center gap-10'>
            <div>
              <Image src={`${isHovering ? '/Emoji2.png' : '/Emoji1.png'}`} alt={''} width={420} height={420}></Image>
