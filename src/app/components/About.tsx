...
const About = () => {
  ...
  return (
    <div>
      <main className='relative flex items-center flex-col justify-center bg-[#161616] px-10 pt-10 z-1 max-lg:h-auto max-lg:py-20'>
        ...
        <motion.section
          ...
          className='flex flex-col gap-20 py-20 max-xl:min-w-auto max-2xl:min-w-[1180px]'
        >
