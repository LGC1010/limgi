        ...
        <ol className='text-white list-decimal pl-5 mt-4'>
          <li>
            ...
            <ul className='list-disc font-[300] pl-6 max-md:text-[11px]'>
              ...
              <li className='mb-4'>
                총합 점수가 100점이 넘어가는 현상 발생하여 유저 랭킹에 영향을 끼침 데이터 합산 로직, 변수가 리셋 안됨을
                확인 이후 Throttling과 unmount시 데이터를 리셋하 여 문제 해결
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul className='list-disc font-[300] pl-6 max-md:text-[11px]'>
              ...
              <li className='mb-4'>
                유저가 문제 삭제시 화면에서 삭제되지 않는 현상발생 react query에서 제공하는 refetch를 이용하여 데이터를
                다시 불러와 문제 해
              </li>
            </ul>
          </li>
