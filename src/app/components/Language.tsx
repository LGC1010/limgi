          ...
          <ul className='flex flex-col gap-6'>
            <li className='flex items-center'>
              ...
              <div className='ml-8 text-white'>
                <strong className='text-[24px] max-md:text-lg'>HTML</strong>
            ...
            <li className='flex items-center'>
              ...
              <div className='ml-8 text-white'>
                <strong className='text-[24px] max-md:text-lg'>CSS</strong>
                <p className='mt-2 max-md:text-[14px]'>
            ...
            <li className='flex items-center'>
              ...
              <div className='ml-8 text-white'>
                <strong className='text-[24px] max-md:text-lg'>JAVASCRIPT</strong>
                <p className='mt-2 max-md:text-[14px]'>
            ...
            <li className='flex items-center'>
              ...
              <div className='ml-8 text-white'>
                <strong className='text-[24px] max-md:text-lg'>TYPESCRIPT</strong>
                <p className='mt-2 max-md:text-[14px]'>
