  ...
  return (
    <div className='max-w-[1000px]'>
      <ul className='flex flex-wrap gap-8 justify-between px-[52px] pt-4 sm:pb-14 md:pb-28'>
        <li>
          <strong className='mb-4 inline-block lg:text-[28px] text-white text-[24px]'>SKILL &amp; ETC</strong>
          <ul className='flex flex-col gap-6'>
            ...
            <li className='flex items-center'>
              ...
              <div className='ml-8 text-white'>
                <strong className='text-[24px]'>GITHUB</strong>
                <p className='mt-2'>
                  GitHub를 활용하여 코드 저장소를 관리하고, 이슈 트래킹 및 Pull Request를 통해 효과적인 협업을 수행할 수
                  있습니다.
                </p>
              </div>
            </li>
